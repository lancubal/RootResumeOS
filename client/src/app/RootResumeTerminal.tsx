...
export default function RootResumeTerminal({ apiUrl, projectsData, aboutMeData }: TerminalProps) {
  ...
  const ALL_COMMANDS = [
    // Custom
    'ls projects', 'cat about-me.md', 'visualize', 'challenge', 'start',
    'edit', 'verify', 'about', 'top', 'help', 'clear', 'whoami', 'login',
    // Common Linux
    'ls', 'pwd', 'echo', 'touch', 'rm', 'mkdir', 'cd', 'cat', 'python', 'gcc', 'rustc'
  ];
